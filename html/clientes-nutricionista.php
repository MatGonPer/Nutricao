...
<body>
    <div class="container">
        ...
        <section class="right">
            <div class="upper">
                <h1>Alunos</h1>
                <input type="search" class="search" name="pesquisar-alunos" id="pesquisasr-alunos" placeholder="Buscar aluno">
            </div>
            <div class="clientes">
                <div class="cliente">
                    <figure>
                    ...
                    <div class="info">
                        ...
                        <p>Busco por evolução constante na musculaão e melhoria do desempenho fisíco</p>
                        <div class="botao">
